...
var _buf; _buf = window_command_hook_prepare_buffer(12);
// GMS >= 1:
...
var _buf; _buf = window_command_hook_prepare_buffer(4);
buffer_write(_buf, buffer_s32, argument0);
...
var _buf; _buf = window_command_hook_prepare_buffer(17);
// GMS >= 1:
buffer_write(_buf, buffer_u64, int64(window_handle()));
...
var _buf; _buf = window_command_hook_prepare_buffer(13);
// GMS >= 1:
buffer_write(_buf, buffer_u64, int64(window_handle()));
buffer_write(_buf, buffer_s32, argument0);
...
var _buf; _buf = window_command_hook_prepare_buffer(1);
